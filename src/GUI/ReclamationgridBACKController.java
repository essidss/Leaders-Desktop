...
//    }
    ...
    private void imprimer(ActionEvent event) throws SQLException {
        ...
        try{
            OutputStream file = new FileOutputStream(new File("C:\\Users\\HP\\Desktop\\jaaavaaaa\\WorkShope3A35\\fact.pdf"));
          ...
          Font font = new Font(Font.FontFamily.HELVETICA, 50, Font.BOLD);
            ...
            Image img=Image.getInstance("C:\\Users\\HP\\Desktop\\jaaavaaaa\\WorkShope3A35\\pdff.png");
            document.add(img);
//         
