...
//                         System.out.println(p);
  Properties properties = new Properties();
    ...
    message.setSubject("GEEKS EVENTS");
...
//    attachment.attachFile(new File("C:/Users/ASUS/Desktop/memoire Les réseaux sociaux pdf.pdf"));*/
   ...
   MimeBodyPart messageBodyPart=new MimeBodyPart();
    messageBodyPart.setContent("<hl>Bienvenu ,Participez a nos evenements !</h1>","text/html");
...
http.setRequestProperty("Authorization", "Bearer ya29.A0ARrdaM_xeF0IvaFhT3xlZZvXyaCPauYtOBj-ugAIt6dvU4Lrt6grJP2XfCqoI3E-byFu3rFCZ-XsJSH89GqYJoCmvlKEZhaqAddO3i-UStKWhih3u645nmEAQmGdA17OLy9R2tmm0aTZj1yp3VT5vcuj3wUm");
